...
export default function NewPostModal({ close, forum_thread_id }: Props) {
    ...
    return (
        ...
        <Modal keepMounted open={true}>
            <Box sx={modalStyle}>
                ...
                <Typography fontSize='30px' mb={3} textAlign='center' color='text.primary'>Please write your post</Typography>
